    ...
    render(){
        ...
        <Fragment>
            <Paper className={classes.paper}>
                <Typography variant="h6" color="secondary" className={classes.paperHeader} align="center">
                    Post your Gig on Giggle
                </Typography>
                <div className={classes.flexPaper}>
                    <div className={classes.profileImageContainer}>
                        <img alt="Profile" src={imageUrl} className={classes.profileImage}/>
                    </div>
...
export default connect(mapStateToProps,{ postScream,clearErrors })(withStyles(styles)(PostGig))